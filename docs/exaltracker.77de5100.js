...
class DialUpdateEvent extends Event {
  constructor(dial) {
    super('dial-update');
    this.dial = dial;
  }
...
exports.DialUpdateEvent = DialUpdateEvent;
let ExaltedDial = class ExaltedDial extends lit_element_1.LitElement {
  constructor() {
    super(...arguments);
    this.min = 0;
    this.max = 10;
    ...
    return lit_element_1.html`
        <div>
            ...
            <input-knob min="${this.min}" max="${this.max}" value="${this.spinning ? this.dial_value : this.value}" step=${this.step} scale=${this.max}
             ...
             @knob-move-start=${e => this.spinning = true}
             @knob-move-end=${e => this.spinning = false}
             >
                <div class="mark">▲</div>
            </input-knob>
        </div>
...
let ToggleBar = class ToggleBar extends lit_element_1.LitElement {
  constructor() {
    super(...arguments);
    this.selected = "";
  }
...
__decorate([lit_element_1.property()], ToggleBar.prototype, "selected", void 0);

ToggleBar = __decorate([lit_element_1.customElement("toggle-bar")], ToggleBar);
exports.ToggleBar = ToggleBar;

class ToggleChangeEvent extends Event {
  constructor(name) {
    super('toggle-change');
    this.name = name;
  }
...
let ToggleOption = class ToggleOption extends lit_element_1.LitElement {
  constructor() {
    super(...arguments);
    this.name = "";
    this.selected = false;
    this.part = "toggle-option";
  }
...
__decorate([lit_element_1.property()], ToggleOption.prototype, "name", void 0);

__decorate([lit_element_1.property()], ToggleOption.prototype, "selected", void 0);

ToggleOption = __decorate([lit_element_1.customElement("toggle-option")], ToggleOption);
exports.ToggleOption = ToggleOption;
let ToggleGroup = class ToggleGroup extends lit_element_1.LitElement {
  constructor() {
    super(...arguments);
    this.label = "";
...
__decorate([lit_element_1.property()], ToggleGroup.prototype, "label", void 0);

__decorate([lit_element_1.property()], ToggleGroup.prototype, "options", void 0);

ToggleGroup = __decorate([lit_element_1.customElement("toggle-group")], ToggleGroup);
...
require("./exalted-dial");

require("input-knob");

require("./toggle-bar"); // @ts-ignore


let ExaltedSliders = class ExaltedSliders extends lit_element_1.LitElement {
  constructor() {
    super(...arguments);
    this.essence_rating = 1;
    this.personal_essence = 10;
    this.peripheral_essence = 10;
    this.committed_essence = 10;
    this.max_willpower = 10;
    this.temp_willpower = 10;
    this.anima_level = 1;
    this.selected = "peripheral_essence";
    this.splat_type = 'Solar';
  }
  ...
  get handle_select_change() {
    return e => {
      ...
      this.splat_type = (_a = e.target) === null || _a === void 0 ? void 0 : _a.value;
  ...
  render() {
    // @ts-ignore
    let estypes = Array.from(essence_values).map(([k]) => lit_element_1.html`<option value="${k}">${k}</option>`);
    let minmax = this.get_min_and_max(this.selected); // @ts-ignore
    ...
    return lit_element_1.html`
        ...
        <toggle-bar selected="${this.selected}" @toggle-change=${e => this.selected = e.name}>
  ...
  get_min_and_max(name) {
    ...
    switch (name) {
      ...
      case 'peripheral_essence':
        ret = {
          min: 0,
          max: this.total_max_periph - this.committed_essence
        };
        break;
...
__decorate([lit_element_1.property()], ExaltedSliders.prototype, "essence_rating", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "personal_essence", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "peripheral_essence", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "committed_essence", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "max_willpower", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "temp_willpower", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "anima_level", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "selected", void 0);

__decorate([lit_element_1.property()], ExaltedSliders.prototype, "splat_type", void 0);

ExaltedSliders = __decorate([lit_element_1.customElement("exalted-sliders")], ExaltedSliders);
let essence_values = new Map([["Solar", [[10, 0], [13, 33], [16, 40], [19, 47], [22, 54], [25, 61]]], ["Terrestrial", [[10, 0], [12, 27], [13, 31], [14, 35], [15, 39], [15, 43]]], ["Sidereal", [[10, 0], [11, 31], [13, 37], [15, 43], [17, 49], [19, 55]]], ["Liminal", [[10, 0], [13, 27], [16, 31], [19, 35], [22, 39], [25, 43]]], ["Lunar", [[10, 0], [13, 31], [13, 37], [15, 43], [17, 49], [19, 55]]]]);
console.log(essence_values);
},{"lit-element":"node_modules/lit-element/lit-element.js","./exalted-dial":"exalted-dial.ts","input-knob":"node_modules/input-knob/dist/input-knob.umd.js","./toggle-bar":"toggle-bar.ts"}],"../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/exaltracker.77de5100.js.map